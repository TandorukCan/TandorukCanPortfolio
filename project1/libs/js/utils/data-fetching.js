...
export const retrieveWeather = (json) => {
  try {
    ...
    const elementsToUpdate = [
      ...
      { id: "todayMinTemp", value: Math.round(todayMinTemp) },
      { id: "todayMaxTemp", value: Math.round(todayMaxTemp) },
      { id: "day1MaxTemp", value: Math.round(day1MaxTemp) },
      { id: "day2MaxTemp", value: Math.round(day2MaxTemp) },
      { id: "day1MinTemp", value: Math.round(day1MinTemp) },
      { id: "day2MinTemp", value: Math.round(day2MinTemp) },
      { id: "day1AvgTemp", value: Math.round(day1AvgTemp) },
      { id: "day2AvgTemp", value: Math.round(day2AvgTemp) },
      { id: "temperature", value: Math.round(temperature) },
